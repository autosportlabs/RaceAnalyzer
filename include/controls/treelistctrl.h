...
public:
    wxTreeListColumnInfo (const wxString &text = wxEmptyString,
        ...
        m_pick_range_min = pickRangeMin;
        m_pick_range_max = pickRangeMax;
    }
    ...
    wxTreeListColumnInfo (const wxTreeListColumnInfo& other) {
		...
		m_pick_range_min = other.m_pick_range_min;
		m_pick_range_max = other.m_pick_range_max;
    }
	...
	int GetPickRangeMin() const { return m_pick_range_min;}
	wxTreeListColumnInfo& SetPickRangeMin(int min){m_pick_range_min = min; return *this;}

	int GetPickRangeMax() const { return m_pick_range_max;}
	wxTreeListColumnInfo& SetPickRangeMax(int max){m_pick_range_max = max; return *this;}
...
private:
    ...
    bool m_edit;
    int m_pick_type;
    int m_pick_range_min;
    int m_pick_range_max;
...
public:
	...
	void SetColumnPickRange(int column, int min, int max);
	int GetColumnPickRangeMin(int column);
	int GetColumnPickRangeMax(int column);
